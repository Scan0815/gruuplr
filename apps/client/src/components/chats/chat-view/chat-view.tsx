    ...
    return [
      ...
      <ion-content>
        ...
        <ion-modal 
          ...
          onDidDismiss={() => this.showInviteModal = false}
        >
          <ion-header>
            <ion-toolbar>
              <ion-title>Invite Members</ion-title>
              <ion-buttons slot="end">
                <ion-button onClick={() => this.showInviteModal = false}>
          ...
          <ion-content>
            <group-invite groupId={this.groupId}></group-invite>
          </ion-content>
        </ion-modal>
      </ion-content>,
      <ion-footer>
